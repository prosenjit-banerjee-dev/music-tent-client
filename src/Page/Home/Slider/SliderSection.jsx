          ...
          <div className="hero-content text-center text-neutral-content">
            <div className="lg:max-w-md">
              <Bounce cascade>
                ...
                <p className="mb-5">
                  Welcome to Music Tent Instrumental Summer School! <br /> Join
                  us for inspiring lessons, ensemble rehearsals, and
                  performances led by accomplished educators and musicians.
                </p>
              </Bounce>
