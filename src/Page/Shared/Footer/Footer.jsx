      ...
      <div className="footer p-10 bg-sky-900 text-neutral-content">
        <div>
          ...
          <p className="flex gap-x-2">
            <CiLocationOn></CiLocationOn> Jeenar Goli,Road No.269,Dhaka
          </p>
          <p className="flex gap-x-2">
            <HiOutlineMail></HiOutlineMail> support@musictent.com
          </p>
          <p className="flex gap-x-2">
            <HiPhone></HiPhone> +88017000000
          </p>
        </div>
        <div>
        ...
        <div>
          <span className="footer-title">Work Hours</span>
          <p className="flex gap-x-2">
            <MdOutlineWatchLater></MdOutlineWatchLater> 9 AM - 5 PM , Sunday -
            Thursday
          </p>
          <p></p>
